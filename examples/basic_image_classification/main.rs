...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    let batcher_valid =
        MnistBatcher::<<MyAutodiffBackend as AutodiffBackend>::InnerBackend>::new(device.clone());
    // let batcher_valid = MnistBatcher::<<Autodiff<burn_fusion::backend::Fusion<JitBackend<WgpuRuntime, f32, i32>>> as AutodiffBackend>::InnerBackend>::new(device.clone());
